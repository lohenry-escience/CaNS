...
# -
#!/usr/bin/env python
def read_single_field_binary(directory,filenamei,iskip):
    import numpy as np
    #
    ...
    # read geometry file
    #
    geofile  = directory+"/geometry.out"
    ...
    fld         = np.fromfile(directory+"/"+filenamei,dtype=precision)
